...
def gross_per_studio(collection)
  ...
  while idx < collection.size
    ...
    studio_gross[collection[idx][:studio]] != true ?  studio_gross[collection[idx][:studio]] = collection[idx][:worldwide_gross] : studio_gross[collection[idx][:studio]] += collection[idx][:worldwide_gross] 
