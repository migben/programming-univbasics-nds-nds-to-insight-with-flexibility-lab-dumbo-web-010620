...
def movies_with_director_key(name, movies_collection)
  ...
  # returns an AoH
  # [dir_name1:{movie_info}, dir_name2:{movie_info}, dir_name3:{movie_info},...,dir_nameNth:{movie_info}]
...
def gross_per_studio(collection)
  ...
  while idx < collection.size
    ...
    # if false then assign this k, v hash else true add to the total gross under the key whose index mach
...
def movies_with_directors_set(src)
  ...
  while idx < src.size # I should instead use length. In something other languages they use length or even len.
